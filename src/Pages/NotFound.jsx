...
return ( <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-indigo-50 to-white px-6 py-20 text-gray-900"> <div className="max-w-2xl text-center">
    ...
    >
      ...
      <button
        type="submit"
        className="px-4 text-indigo-600 hover:text-indigo-700 transition"
        aria-label="Search"
      >
        <Search size={20} />
      </button>
    ...
    >
      <Link
        to="/"
        className="flex items-center gap-2 bg-indigo-600 text-white px-6 py-3 rounded-md font-medium hover:bg-indigo-700 transition"
      >
        <Home size={18} />
        Go Home
      </Link>
