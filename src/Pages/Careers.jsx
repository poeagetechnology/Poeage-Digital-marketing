...
return ( <main className="pt-24 bg-gradient-to-br from-gray-50 via-indigo-50 to-white min-h-screen"> <section className="max-w-6xl mx-auto px-4 py-20">
    ...
    >
      <h1 className="text-5xl font-bold mb-6">
        Join <span className="text-indigo-600">Poeage</span>
      </h1>
