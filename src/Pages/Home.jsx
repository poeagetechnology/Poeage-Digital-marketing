...
return ( <main className="bg-gray-50">
  ...
  {/* HERO */}
  <section className="relative overflow-hidden bg-gradient-to-br from-gray-50 via-indigo-50 to-white text-gray-900">
    ...
    <div className="relative max-w-7xl mx-auto px-6 py-28 grid md:grid-cols-2 gap-14 items-center">
      ...
      <motion.div
        ...
        className="bg-white border rounded-2xl p-6 shadow-xl"
      >
        <img
