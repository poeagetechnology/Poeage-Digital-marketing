...
return ( <section className="bg-gradient-to-br from-gray-50 via-indigo-50 to-white py-28 px-6"> <div className="max-w-7xl mx-auto">
    ...
    <div className="grid lg:grid-cols-2 gap-16">
      ...
      {/* INFO */}
      <motion.div variants={stagger} initial="hidden" whileInView="show" className="space-y-8">
        {[
          { title: "Email", value: "sales@poeage.com" },
          { title: "Phone", value: "+91 98765 43210" },
          { title: "Office", value: "Tamil Nadu, India" },
        ].map((item) => (
    ...
    {/* MAP */}
    <motion.div variants={fadeUp} initial="hidden" whileInView="show" className="mt-20 rounded-2xl overflow-hidden shadow-lg">
      <iframe
        title="Google Map"
