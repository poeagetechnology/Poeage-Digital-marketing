...
email: "[gowridyk3@gmail.com](mailto:gowridyk3@gmail.com)",
linkedin: "#",
twitter: "#",
},
{
...
img: "https://via.placeholder.com/400",
email: "[preethika@gmail.com](mailto:preethika@gmail.com)",
linkedin: "#",
twitter: "#",
},
{
...
img: "https://via.placeholder.com/400",
email: "[vignesh@gmail.com](mailto:vignesh@gmail.com)",
linkedin: "#",
twitter: "#",
},
];
...
return ( <section className="bg-gradient-to-br from-gray-50 via-indigo-50 to-white text-gray-900 py-28 px-6"> <div className="max-w-7xl mx-auto">
    ...
    >
      <motion.span variants={fadeUp} className="text-indigo-600 font-semibold uppercase text-sm">
        About Poeage
      </motion.span>

      <motion.h1 variants={fadeUp} className="text-4xl md:text-5xl font-bold mt-4 mb-6">
        Structured <span className="text-indigo-600">Digital Growth Consultancy</span>
      </motion.h1>
        ...
        {team.map((member, i) => (
          <motion.div key={i}>
            <Card hover padding="lg">
              ...
              <p className="text-indigo-600 text-sm mb-4">{member.title}</p>
    ...
    {/* STATS */}
    <div className="grid md:grid-cols-4 gap-10 text-center mb-28">
      {stats.map((stat, i) => (
        <Card key={i}>
