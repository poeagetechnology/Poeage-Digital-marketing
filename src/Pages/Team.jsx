...
return ( <Card
 ...
 > <img
  ...
  <p className="text-indigo-600 text-sm mb-3">{member.title}</p>
  ...
  <div className="flex justify-center gap-6 text-gray-400 text-lg">
    ...
    <a href={member.twitter} className="hover:text-indigo-600 transition">
      <FaTwitter />
    </a>
    <a href={`mailto:${member.email}`} className="hover:text-indigo-600 transition">
      <FaEnvelope />
    </a>
  </div>
</Card>
...
return ( <section className="bg-gradient-to-br from-gray-50 via-indigo-50 to-white py-28 px-6 text-gray-900"> <div className="max-w-7xl mx-auto">
...
```
    ...
    <div className="mt-32 text-center">
      ...
      <Link
        to="/careers"
        className="inline-block bg-indigo-600 text-white px-14 py-4 rounded-lg font-semibold shadow-lg
