...
return ( <section className="bg-gradient-to-br from-gray-50 via-indigo-50 to-white py-28 px-6 text-gray-900"> <div className="max-w-7xl mx-auto space-y-24">
    ...
    <div className="grid md:grid-cols-2 gap-10 items-center">
      <div>
        <Lock className="text-indigo-600 mb-4" size={36} />
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {[
          ...
          <Card key={item} padding="lg">
            <Server className="text-indigo-600 mb-3" />
    ...
    <div>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {[
          ...
          <Card key={item.title}>
            <FileCheck className="text-indigo-600 mb-3" />
    ...
    <div className="grid md:grid-cols-2 gap-10">
      <Card padding="lg" shadow="md">
        <Bug className="text-indigo-600 mb-3" />
      ...
      <div className="grid md:grid-cols-4 gap-6">
        {[
          ...
          <Card key={step} padding="md">
            <AlertTriangle className="text-indigo-600 mb-2" />
