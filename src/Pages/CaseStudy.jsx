...
return ( 
<section className="bg-gradient-to-br from-gray-50 via-indigo-50 to-white py-28 px-6"> <div className="max-w-7xl mx-auto">
      ...
      {caseStudies.map((study, index) => (
        ...
        >
          <Link
            ...
            className="group block bg-white rounded-2xl border border-gray-200 p-8 shadow-sm hover:shadow-lg transition relative overflow-hidden"
          >
            ...
            {/* CTA */}
            <div className="mt-6 text-indigo-600 font-medium text-sm group-hover:translate-x-1 transition">
