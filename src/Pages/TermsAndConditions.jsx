...
`,
    },
    {
      ...
      content: `
Email: [legal@poeage.com](mailto:legal@poeage.com)
...
return (
   <section className="bg-gradient-to-br from-gray-50 via-indigo-50 to-white py-20 px-6 print:px-0">
      ...
      {sections.map((section) => (
        <Card key={section.id} id={section.id} padding="lg">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <Badge variant="subtle">Legal</Badge>
          </div>
