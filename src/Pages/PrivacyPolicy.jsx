...
return ( <section className="bg-gradient-to-br from-gray-50 via-indigo-50 to-white py-20 px-6 print:px-0"> <div className="max-w-5xl mx-auto">

    {/* HEADER */}
    <div className="text-center mb-14">
      <h1 className="text-4xl font-bold mb-3 mt-8">Privacy Policy</h1>
      ...
      {sections.map((section) => (
        ...
        >
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <Badge variant="subtle">Policy</Badge>
          </div>
